define("assignsubmission_cloudpoodll/copy_to_clipboard",["core/str","core/toast"],(function(_str,_toast){
/**
   ...
   * </button>
   */
var component="assignsubmission_cloudpoodll",copyNodeContentToClipboard=function(copyButton,copyTarget){return copyTarget.select(),document.execCommand("copy")?(displaySuccessToast(copyButton),!0):(displayFailureToast(),!1)},displaySuccessToast=function(copyButton){return getSuccessText(copyButton).then((function(successMessage){return(0,_toast.add)(successMessage,{})}))},displayFailureToast=function(){return getFailureText().then((function(message){return(0,_toast.add)(message,{type:"warning"})}))},getFailureText=function(){return(0,_str.get_string)("unabletocopytoclipboard","core")},getSuccessText=function(copyButton){return copyButton.dataset.clipboardSuccessMessage?Promise.resolve(copyButton.dataset.clipboardSuccessMessage):(0,_str.get_string)("textcopiedtoclipboard","core")},getTextFromContainer=function(container){return container.value?container.value:container.innerText?container.innerText:null},loaded=!1;loaded||((0,_str.get_strings)([{key:"textcopiedtoclipboard",component:component},{key:"unabletocopytoclipboard",component:component}]),document.addEventListener("click",(function(e){var copyButton=e.target.closest('[data-action="copy"]');if(copyButton&&copyButton.dataset.clipboardTarget){var copyTarget=document.querySelector(copyButton.dataset.clipboardTarget);if(copyTarget){e.preventDefault();var textToCopy=getTextFromContainer(copyTarget);if(textToCopy)if(navigator.clipboard)navigator.clipboard.writeText(textToCopy).then((function(){return displaySuccessToast(copyButton)})).catch();else if(copyTarget instanceof HTMLInputElement||copyTarget instanceof HTMLTextAreaElement)copyTarget.focus(),copyNodeContentToClipboard(copyButton,copyTarget)&&copyButton.focus();else{var copyRegion=document.createElement("textarea");copyRegion.value=textToCopy,copyRegion.classList.add("sr-only"),document.body.appendChild(copyRegion),copyNodeContentToClipboard(copyButton,copyRegion),copyRegion.remove(),copyButton.focus()}else displayFailureToast()}}})),loaded=!0)}));
