 ...
 */
define("assignsubmission_cloudpoodll/modalformhelper",["jquery","core/log","core/str","core/modal_cancel","core/modal_events","core/fragment"],(function($,log,Str,ModalCancel,ModalEvents,Fragment){var TheForm=function(selector){this.init(selector)};return TheForm.prototype.modal=null,TheForm.prototype.init=function(selector){var dd=this;$("body").on("click",selector,(function(e){e.preventDefault(),dd.modaldata={contextid:$(this).data("contextid"),mediaurl:$(this).data("mediaurl"),mediatype:$(this).data("mediatype"),transcripturl:$(this).data("transcripturl"),lang:$(this).data("lang")},ModalCancel.create({title:dd.formtitle,body:dd.getBody(dd.modaldata)}).then((function(modal){return dd.modal=modal,dd.modal.getRoot().on(ModalEvents.hidden,function(){dd.modal.setBody(dd.getBody(dd.modaldata))}.bind(dd)),dd.modal.show(),dd.modal}))}))},TheForm.prototype.getBody=function(modaldata){return Fragment.loadFragment("assignsubmission_cloudpoodll","mform",modaldata.contextid,modaldata)},{init:function(selector){return new TheForm(selector)}}}));
