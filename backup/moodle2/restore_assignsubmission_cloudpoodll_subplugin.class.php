 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_assignsubmission_cloudpoodll_subplugin extends restore_subplugin {
    ...
    /**
     * Processes one assignsubmission_cloudpoodll element
     *
     * @param mixed $data
     */
    public function process_assignsubmission_cloudpoodll_submission($data) {
        global $DB;
