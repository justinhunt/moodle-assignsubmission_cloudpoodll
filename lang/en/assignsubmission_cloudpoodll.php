...
$string['freetrial_desc'] = "Cloud Poodll Submissions is a premium Moodle plugin. A free trial can be set up in a couple of minutes without leaving your Moodle site. For details on pricing visit <a href='https://poodll.com/pricing'>Poodll.com</a>. ";
...
$string['cbsetupintro'] = "Cloud Poodll Submissions cannot run until the Poodll API user and secret have been set for this site. They are site wide settings, so you only need to do this once.";
...
$string['cbgotosettings'] = "Go to the Cloud Poodll Submissions settings page";
